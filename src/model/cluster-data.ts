...
export type ClusterType = | "Cluster" | "<none>" | "Node" | "Namespace" | "Deployment" | "Statefulset" | "DaemonSet" | "ReplicaSet" | "Pod" | "Container" | "Job";
...
export const kubernetesElements: KubernetesElement[] = ([
    ...
    {type: "Job",           level: 4, query: "kube_job_owner",          label: "job_name",      ancestor: "owner_name", ancestorType: "owner_kind",  alternativeAncestor: "namespace",  alternativeAncestorType: "Namespace"},
