...
export const kubernetesElements: KubernetesElement[] = ([
    ...
    {type: "CronJob",       level: 4, query: "kube_cronjob_labels",     label: "CronJob",       ancestor: "owner_name", ancestorType: "owner_kind",  alternativeAncestor: "namespace",  alternativeAncestorType: "Namespace"},
    {type: "Job",           level: 5, query: "kube_job_owner",          label: "job_name",      ancestor: "CronJob",    ancestorType: "CronJob",     alternativeAncestor: "namespace",  alternativeAncestorType: "Namespace"},
