...
%     \item Go to the \textbf{Infrastructure \(\rightarrow\) Kubernetes cluster} tab and install there a new agent (choose the ins-cluster-agent in the drop down menu)
%     \item Save the token! (Our Token: r8J8f3ve-DsU-v8cmrRSZx\_-atYyJqVCyePyk7zVCvSADy5-qg)
