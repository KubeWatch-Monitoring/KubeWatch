...
Working on the master branch is only allowed when the documentation is updated.
...
\begin{tabular}{l|l}
  ...
  \textbf{Time / Effort:} & Label with format xx\$ \\
...
\subsection{Team member becomes unavailable}
