...
\begin{longtable}[h!]{p{2.2cm} | p{4cm} | p{4cm} | p{1.5cm} | p{1.5cm} | p{1.5cm}}
    ...
    \hline
        ...
        Unknown API 
            ...
            & As a first step we investigated the API and did a few preliminary test to see how it works. The results were positive but we may need to do more tests when the architecture is further refined. For the milestone 3 we test the API to access each component of the system.
            & 30\% & 5 & 3 \\ \hline
        ...
        Unknown Development Environment
            ...
            & Each of the team members tested the local development environment and it works. The development environment on the INS Cluster is not fully tested, this should be done as fast as possible. But with this step the risk for the development environment is mostly mitigated.
            & 20\% & 5 & 2.2 \\ \hline
        Scrum Methodology 
            ...
            & The Software Engineering Project module, which we attend in parallel, is designed to support us in learning and applying Scrum. During the last weeks we get some regularity in how to use the SCUM methodology and it works really good until now, but there is already a risk because we need more regularity to manage Scrum as good as we need it.
            & 10\% & 1 & 0.4 \\ \hline
        New Architecture 
