...
% TODO not happy with the Test follwing two sentences
...
The usability tests are done by some students from the CldOp Module.
...
% TODO maybe improve follwing paragraph
\subsection{Integration into Workflow}
Before pushing any changes to the git repository all Unit and Integrations tests must be run successfully.
...
% TODO verify that we DRY in follwing paragraph with section 2.2 Non-Functional Requirements
...
% TODO should we keep infos like the follwing sentence in the documentation inside the Test Concept security chapter? or is it maybe already shown in the security assessments/threat model
