...
We use Scrum and therefore, all estimates and other refinements are made every two weeks in the sprint meeting.
...
User stories are categorized into Epics. The more left an Epic is on the Storymap board the higher the priority.
...
\begin{tabular}{ | m{8em} | m{25em}| } 
 ...
 \textbf{Priority} & High \\
 \hline
 \textbf{Measure(s)} & The Software displays a message if any APIs are missing.\\
 \hline
...
\begin{tabular}{ | m{8em} | m{25em}| } 
 ...
 \textbf{Priority} & Middle \\
 \hline
 \textbf{Measure(s)} & The frontend displays a message, if it is fully functional again.\\
 \hline
