...
\begin{tabular}{ | m{8em} | m{25em}| } 
 ...
 \textbf{ID} & NFR-5\\ 
 \hline
 \textbf{Requirement} & The product must be scalable for availability.\\
 \hline
...
\begin{tabular}{ | m{8em} | m{25em}| } 
 ...
 \textbf{ID} & NFR-11\\ 
 \hline
 \textbf{Requirement} & The product supports as many pods as Prometheus because it depends on it.
 \hline
 \textbf{Priority} & Middle\\
 \hline
 \textbf{Measure(s)} & Software runs as expected with 10 Pods. \\
 \hline
