...
\begin{tabular}{ | m{8em} | m{25em}| } 
 ...
 \textbf{ID} & NFR-5\\ 
 \hline
 \textbf{Requirement} & The product must support at least 10 pods. \\
 \hline
 \textbf{Priority} & Middle\\
 \hline
 \textbf{Measure(s)} & Software is usable with 10 pods.\\
 \hline
 \textbf{Process} & Let the software monitor at least 10 pods.\\
 \hline
\end{tabular}
\end{center}
...
\begin{tabular}{ | m{8em} | m{25em}| } 
 ...
 \textbf{ID} & NFR-7\\ 
 \hline
 \textbf{Requirement} & The software must handle absence of the cluster.\\
 \hline
 \textbf{Priority} & High \\
 \hline
 \textbf{Measure(s)} & Software sends Notification about missing cluster.\\
 \hline
 \textbf{Process} & Let the software run without connection to the cluster.\\
 \hline
\end{tabular}
\end{center}
...
\begin{tabular}{ | m{8em} | m{25em}| } 
 ...
 \textbf{ID} & NFR-8\\ 
 \hline
 \textbf{Requirement} & The software must reconnect to the cluster automatically.\\
 \hline
 \textbf{Priority} & Middle \\
 \hline
 \textbf{Measure(s)} & The software sends Notification that the cluster is alive again.\\
 \hline
 \textbf{Process} & Start software without cluster and start cluster after software.\\
 \hline
\end{tabular}
\end{center}
