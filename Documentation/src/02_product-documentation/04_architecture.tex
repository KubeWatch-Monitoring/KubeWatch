...
% TODO should we keep the accessing deployed applciation section? maybe move/copy it to the readme?
\subsection{Accessing Deployed Application}
To access current main version of KubeWatch, you need to be connected to the INS network via VPN.
Navigate to \href{https://gitlab.ost.ch/SEProj/2022-FS/g03-kubewatch/kubewatch/-/environments}{Deployments / Environments} in Gitlab section and click \textit{Open} to access the current main version of KubeWatch.
...
\section{Wireframe}
% TODO change the follwing sentence
